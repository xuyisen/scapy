...
This section provides some examples that show how to benefit from Scapy functions in
your own code.
...
The following example explains how to use the checksum() function to compute and UDP
checksum manually. The following steps must be performed:
